...
namespace BankingSystemAssessment.API.Infrastructure
{
    public static class Utilities
    {
        ...
        {
            bankingSystemContext.Transaction.Add(new Domain.Transaction { Id = 1, AccountId = 1, ReferenceNumber = "FT1519991872", Description = "Deposit 1000 EGP", Debit = 0, Credit = 2000, TransactionDate = new DateTimeOffset(2019, 05, 16, 15, 26, 07, new TimeSpan(1, 0, 0)), TranscationType = TranscationType.Deposit.ToString(), BalanceAfter = 2000 });
            bankingSystemContext.Transaction.Add(new Domain.Transaction { Id = 2, AccountId = 1, ReferenceNumber = "FT1529991872", Description = "Withdrawal 1000 EGP", Debit = 1000, Credit = 0, TransactionDate = new DateTimeOffset(2019, 08, 17, 15, 26, 07, new TimeSpan(1, 0, 0)), TranscationType = TranscationType.Withdrawal.ToString(), BalanceAfter = 1000 });
